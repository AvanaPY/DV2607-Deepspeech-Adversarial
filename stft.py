...
class STFT(torch.nn.Module):
    def __init__(self, 
        ...
        self.register_buffer('forward_basis', forward_basis.float().to(self._device))
        self.register_buffer('inverse_basis', inverse_basis.float().to(self._device))
    ...
    def forward(self, input_data):
        ...
        self.magnitude = self.magnitude.transpose(1, 2).unsqueeze(0)
